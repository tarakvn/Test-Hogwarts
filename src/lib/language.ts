...
import { persianSpellTranslations, type Spell } from "@/data/spells";
...
const potionText: Record<string, NonNullable<Spell["potion"]>> = {
  ...
  wiggenweld: {
    ...
    steps: [
      {prompt: "دم کردن معجون را آغاز کنید.", answer: "خون سمندر را تا قرمز شدن معجون اضافه کنید.", decoys: ["خارهای ماهی شیر را اضافه کنید.", "آب عسل را اضافه کنید.",],},
      {prompt: "معجون قرمز است.", answer: "تا زمانی که معجون نارنجی شود هم بزنید.", decoys: ["حرارت دهید تا به رنگ نیلی درآید.", "مخاط کرم فلوبر را اضافه کنید.",],},
      {prompt: "معجون نارنجی است.", answer: "خون سمندر بیشتری اضافه کنید تا زرد شود.", decoys: ["آب بلوبری را اضافه کنید.", "قابلمه را از روی حرارت بردارید.",],},
      {prompt: "معجون زرد است.", answer: "هم بزنید تا معجون سبز شود", decoys: ["پنج عدد خار شیرماهی اضافه کنید.", "آب عسل اضافه کنید.",],},
      {prompt: "معجون زرد است.", answer: "خون سمندر بیشتر اضافه کنید تا معجون فیروزه‌ای شود.", decoys: ["مخاط کرم فلوبر را اضافه کنید.","حرارت دهید تا صورتی شود.",],},
      {prompt: "معجون فیروزه ای است.",answer: "حرارت دهید تا نیلی شود.", decoys: ["هم بزنید تا نارنجی شود.","آب عسل اضافه کنید.",],},
      {prompt: "معجون نیلی است.", answer: "خون سمندر بیشتر اضافه کنید تا معجون صورتی شود.",decoys: ["پنج خار شیرماهی اضافه کنید.","از روی حرارت بردارید.",],},
      {prompt: "معجون صورتی است.", answer: "حرارت دهید تا معجون قرمز شود.", decoys: ["مخاط کرم فلوبر اضافه کنید.","هم بزنید تا سبز شود",],},
      {prompt: "معجون دوباره قرمز است.", answer: "پنج خار شیرماهی اضافه کنید.",decoys: ["سریعا پنج خار شیرماهی اضافه کنید.","آب عسل اضافه کنید.",],},
      {prompt: "معجون تا وقتی زرد شدن حرارت داده شده است.", answer: "پنج خار شیر ماهی دیگر اضافه کنید.",decoys: ["خون سمندر اضافه کنید.","معجون را از روی حرارت بردارید.",],},
      {prompt: "خارهای شیرماهی داخل آن هستند.", answer: "مخاط کرم فلوبر را تا زمانی که معجون بنفش شود اضافه کنید.",decoys: ["آب بلو بری اضافه کنید.","هم بزنید تا فیروزه‌ای شود.",],},
      {prompt: "معجون بنفش است.",answer: "هم بزن تا معجون قرمز شود.", decoys: ["حرارت دهید تا نیلی شود.","آب عسل اضافه کنید.",],},
      {prompt: "معجون قرمز است.",answer: "مخاط کرم فلوبر را تا زمانی که معجون نارنجی شود اضافه کنید.",decoys: ["خون سمندر بیشتری اضافه کنید.","خار شیرماهی اضافه کنید.",],},
      {prompt: "معجون نارنجی است.", answer: "هم بزنید تا زرد شود.", decoys: ["حرارت دهید تا فیروزه‌ای شود.","سریعا آب عسل اضافه کنید.",],},
      {prompt: "معجون باز هم زرد است.", answer: "تا زمانی که فیروزه‌ای شود آب عسل اضافه کنید.",decoys: ["خون سمندر اضافه کنید.","پنج عدد خار شیرماهی اضافه کنید.",],},
      {prompt: "معجون فیروزه‌ای است.", answer: "چند قطره آب بلو بری اضافه کنید.", decoys: ["مخاط کرم فلوبر بیشتری اضافه کنید.","پنج خار شیرماهی اضافه کنید.",],},
      {prompt: "ماده نهایی داخل است.",answer: "معجون را هم بزنید و بگذارید سی دقیقه بجوشد.",decoys: ["فورا آن را در بطری بریزید.","بدون هم زدن معجون را خنک کنید.",],},
      {prompt: "سی دقیقه آرام جوشیدن تمام شد.", answer: "معجون را از روی حرارت بردارید.",decoys: ["سی دقیقه دیگر حرارت دهید.","خون سمندر بیشتر اضافه کنید.",],},
      {prompt: "معجون از روی حرارت برداشته شده است.",answer: "بگذارید خنک شود.",decoys: ["آن را به آتش برگردانید.","آب عسل بیشتر اضافه کنید.",],},
      {prompt: "معجون خنک شده است.", answer: "معجون برای مصرف آماده است.",decoys: ["پنج خار شیرماهی دیگر اضافه کن.","به حرارت دادن آن ادامه دهید.",],},],
  },
};
  ...
  return {
    ...
    ...(spell.potion ? {
      potion: potion
        ? {
            ...potion,
            difficulty: text?.difficulty ?? potion.difficulty,
            steps: potion.steps.length ? potion.steps : spell.potion.steps,
          }
        : spell.potion,
    } : {}),
  };
